								...
								<table border="0" cellpadding="0" cellspacing="0" width="260" class="emailButton">
									<tr>
										<td align="center" valign="middle" class="buttonContent">
											<a href="@yield('button_url_1')" target="_blank">@yield('button_link_text_1')</a>
										</td>
									</tr>
								</table>
								<!-- // CONTENT TABLE -->
						...
						<tr>
							<td align="center" valign="top" width="600" class="flexibleContainerCell bottomShim">
								...
								<table border="0" cellpadding="0" cellspacing="0" width="260" class="emailButton">
									<tr>
										<td align="center" valign="middle" class="buttonContent">
											<a href="@yield('button_url_2')" target="_blank">@yield('button_link_text_2')</a>
										</td>
									</tr>
								</table>
								<!-- // CONTENT TABLE -->
						...
						<tr>
							<td align="center" valign="top" width="600" class="flexibleContainerCell bottomShim">
								...
								<table border="0" cellpadding="0" cellspacing="0" width="260" class="emailButton">
									<tr>
										<td align="center" valign="middle" class="buttonContent">
											<a href="@yield('button_url_3')" target="_blank">@yield('button_link_text_3')</a>
										</td>
									</tr>
								</table>
								<!-- // CONTENT TABLE -->
